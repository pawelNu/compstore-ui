...
import { AddNewPC } from "../../../types/NewPC";
...
export const NewPC: React.FC = () => {
  ...
  const [pc, setPc] = useState<AddNewPC>({
  ...
  return (
    <>
      <form onSubmit={(e) => onSubmit(e)}>
        ...
        <div className="row mb-3">
          <label htmlFor="ramGBCapacity" className="col-sm-2 col-form-label">
            RAM GB Capacity
          </label>
          <div className="col-sm-10">
            <input
        ...
        <div className="row mb-3">
          <label htmlFor="driveGBCapacity" className="col-sm-2 col-form-label">
            Drive GB Capacity
          </label>
          <div className="col-sm-10">
            <input
